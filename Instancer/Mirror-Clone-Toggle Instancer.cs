...
namespace VRLabs.MirrorCloneToggle
{
	public class MirrorCloneToggle : ScriptableObject
	{
		public const string packageName = "Mirror-Clone-Toggle";
		...
		[MenuItem("VRLabs/Create Instance/Mirror Clone Toggle")]
